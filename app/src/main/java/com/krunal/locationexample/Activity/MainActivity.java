  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    check.setOnClickListener(
        v -> {
          ...
          //                    myJob = new JobInfo.Builder(105, new ComponentName(this,
          // LocationJob.class))
          //                            .setPeriodic(TimeUnit.HOURS.toMillis(1),
          // TimeUnit.HOURS.toMillis(1))
          //                            .setPersisted(true)
          //                            .setRequiresCharging(false) // we don't care if the device
          // is charging or not
          //                            .build();
          //
          //                } else {
          ...
          /**
           * This is to get location from background every haft an Hour in day time. In night time
           * after 8 pm we will get Location every 2 Hour.
           */
          ...
          //
          //                if
          // (!ClsGlobal.isWorkScheduled(ClsGlobal.packageName.concat(".Location.30min"))) {
          //
          ...
          //
          //                if
          // (!ClsGlobal.isWorkScheduled(ClsGlobal.packageName.concat(".Location.120min"))) {
          //
  ...
  public void requestLocationPermission() {
    ...
    if (EasyPermissions.hasPermissions(this, perms)) {
      ...
      EasyPermissions.requestPermissions(
          this, "Please grant the location permission", REQUEST_LOCATION_PERMISSION, perms);
    }
  }
