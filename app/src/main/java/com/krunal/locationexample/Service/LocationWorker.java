...
public class LocationWorker extends Worker {
  ...
  public Result doWork() {
    ...
    /**
     * This is to get location from background every haft an Hour in day time. In night time after 8
     * pm we will get Location every 2 Hour.
     */
    ...
    //                CheckNewWorker = true;
    //                ClsGlobal.ScheduleWorker(ClsGlobal.packageName.concat(".Location.120min"),
    // 120);
    //            }
    //
